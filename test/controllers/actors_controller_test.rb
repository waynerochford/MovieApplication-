...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { age: @actor.age, famous_movies: @actor.famous_movies, image_url: @actor.image_url, name: @actor.name }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { age: @actor.age, famous_movies: @actor.famous_movies, image_url: @actor.image_url, name: @actor.name }
    assert_redirected_to actor_path(assigns(:actor))
  end
